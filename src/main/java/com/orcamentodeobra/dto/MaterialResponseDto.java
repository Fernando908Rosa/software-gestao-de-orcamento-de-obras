...
public class MaterialResponseDto {
	...
	public MaterialResponseDto(Long id, String descricaodomaterial, String cimento, String tijolo, String areia,
			String brita, String azuleijo, String cimentocola, String fio, String cruzetinha, String cano, String cola,
	...
	public static MaterialResponseDto converterMaterialParaMaterialResponseDto(Material material) {
		return new MaterialResponseDto(material.getId(), material.getDescricaodomaterial(), material.getCimento(), material.getAreia(),
				material.getTijolo(), material.getBrita(), material.getAzuleijo(), material.getCimentocola(),
				material.getFio(), material.getCruzetinha(), material.getCano(), material.getCola(), material.getMadeira(),
				material.getForropvc(), material.getPrego());
